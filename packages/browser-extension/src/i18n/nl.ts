export default {
  ...
  picker: {
    ...
    elementColor: 'Element kleur:',
    textcolor: 'Tekst kleur:',
    borderColor: 'Rand kleur:',
    outlineColor: 'Omtrek kleur:',
    ringColor: 'Ring kleur:',
  ...
  contrast: {
    ...
    element: 'Element kleur',
    text: 'Tekst kleur',
    pageBackground: 'Pagina achtergrond',
    textVsElement: 'Tekst op element',
    elementVsPage: 'Element op achtergrond',
