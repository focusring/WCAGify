  ...
  <div class="mx-auto max-w-6xl px-6">
    ...
    <section class="py-16">
      <div class="grid w-full grid-cols-1 items-center gap-10 lg:grid-cols-2">
        <div>
          <h1 class="mb-4 text-sm font-bold tracking-widest text-(--vp-c-brand-1)">
            <span
          ...
          <div class="mt-8 flex flex-col gap-3 sm:flex-row">
            <a
              ...
              class="inline-flex items-center justify-center rounded-lg bg-(--vp-button-brand-bg) px-6 py-3 text-[0.9375rem] font-semibold text-white no-underline transition hover:-translate-y-px hover:bg-(--vp-button-brand-hover-bg)"
            >
              Get Started
            </a>
            <a
              href="https://demo.wcagify.com/"
              class="inline-flex items-center justify-center rounded-lg border border-(--vp-c-border) bg-transparent px-6 py-3 text-[0.9375rem] font-semibold text-(--vp-c-text-1) no-underline transition hover:-translate-y-px hover:border-(--vp-c-brand-1) hover:text-(--vp-c-brand-1)"
              target="_blank"
              rel="noopener"
            >
              Live Demo
        ...
        <div class="flex items-center">
          <div
            class="w-full overflow-hidden rounded-xl border border-(--vp-c-border) bg-(--vp-c-bg-soft)"
          >
    ...
    <section class="pb-30 pt-20 text-center">
      <p class="mb-8 text-[clamp(1.5rem,3vw,2rem)] font-bold leading-snug text-(--vp-c-text-1)">
        Stop wrestling with report templates.<br />
        Start writing findings.
      </p>
      <a
        href="/guide/getting-started"
        class="inline-flex items-center rounded-lg bg-(--vp-button-brand-bg) px-6 py-3 text-[0.9375rem] font-semibold text-white no-underline transition hover:-translate-y-px hover:bg-(--vp-button-brand-hover-bg)"
      >
        Read the docs
      </a>
    </section>
