...
The search block at the top of the home page is headed **"Goedenavond,"** (in the morning "Goedemorgen,", in the afternoon "Goedemiddag,"). The heading introduces the question "<span lang="nl">Waarmee kunnen we je vooruit helpen?</span>", the site search and the eight shortcut tiles, but a greeting names none of that.
