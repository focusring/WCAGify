...
The same component appears wherever the cookie settings can be opened, which is every page in the audit. It was confirmed on page-2, page-4, page-7, page-8, page-9, page-11, page-12, page-13, page-18, page-19, page-23 and page-24, and earlier on page-26 to page-30. On the Dutch pages it fails at desktop width only: at a phone width of 390 pixels the longer text wraps onto two lines, the link becomes 36 pixels high (167.75 by 36 on page-11) and passes. On the English pages the same link reads "View Privacy Policy", stays on one line and measures 117.5 by 18 pixels at 1280 and at 390 pixels alike, so there it fails on phones too (page-26).
