...
A screen reader reads the tags out. Instead of "<span lang="nl">Hypotheek extra aflossen</span>" the user hears something like "less-than b greater-than Hypotheek less-than slash b greater-than extra aflossen", depending on the synthesiser — six of the nine suggestions for "hypotheek" are affected on this page.
