...
On the result view of the mortgage wizard ("<span lang="nl">Uw hypotheek en maandbedrag</span>"), two cards invite the next step. At full width each has a heading, a paragraph and a button:

- **"<span lang="nl">Al een woning op het oog?</span>"**: "De keuze van de woning heeft invloed op uw hypotheek. Bij een hoger energielabel kunt u tot € 40.000 meer lenen en krijgt u een rentekorting. …", then "<span lang="nl">Voeg een woning toe</span>";
- **"<span lang="nl">Wilt u een gratis financiële check?</span>"**: "<span lang="nl">Tijdens een gratis en vrijblijvend oriëntatiegesprek …</span>", then "<span lang="nl">Maak een afspraak</span>".
