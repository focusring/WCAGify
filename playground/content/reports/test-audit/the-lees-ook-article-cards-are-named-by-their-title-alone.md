...
Under **"<span lang="nl">Lees ook</span>"** on the energy-saving tips page, each related article is one link card that shows a title, two tag chips and a date, for example "<span lang="nl">Bescherm je huis tegen inbraak · Top 5 · Voor huiseigenaren · 20-11-2025</span>". The link's `aria-label` holds only the title, "<span lang="nl">Bescherm je huis tegen inbraak</span>", so the chips and the date that are visibly part of the link are not in its name. The same goes for the other two cards ("<span lang="nl">Lars verduurzaamde zijn huis van energielabel E naar A+++</span>", "<span lang="nl">4 tips voor een koel huis zonder airco</span>"). axe's experimental rule `label-content-name-mismatch` flags all three.
