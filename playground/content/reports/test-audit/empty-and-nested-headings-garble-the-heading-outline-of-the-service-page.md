...
- under the page heading "<span lang="nl">Service en Contact</span>" sits an **empty** `<h2 class="emc-mt-2 emc-h3"></h2>`. It shows nothing, but a screen reader lists it as a level-2 heading with no text;
...
- the small line "<span lang="nl">Waarmee kunnen we je vooruit helpen?</span>" (20 px) is a third `<h1>`, beside headings drawn at 40 and 32 px.
...
The address-change page (page-22) has an empty heading too: the section widget "<span lang="nl">Of e-mail, telefoonnummer of naam</span>" renders an empty `<h2>` between that title and "<span lang="nl">Adres wijzigen voor jezelf</span>".
