...
The window is the embedded chat component (`<chat-client>`), the same on every page that offers the chat. Also on page-4, reproduced at 320 and 375 pixels, where the "chat werkt op dit moment niet" notice is cut too; the same component is embedded on page-8 and page-19.
