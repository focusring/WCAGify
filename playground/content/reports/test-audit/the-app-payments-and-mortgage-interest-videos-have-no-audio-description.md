---
title: 'The app, payments and mortgage-interest videos have no audio description'
sc: 1.2.5
severity: High
type: Content
sample: page-18
...
![Six full-screen green cards from the app video with white capitals, five questions such as "GEBRUIKT U DE ABN AMRO APP?" and "HOE VEILIG VINDT U DE APP?" and the closing line "REGEL UW BANKZAKEN ZOALS U DAT WILT](/api/uploads/test-audit/the-app-payments-and-mortgage-interest-videos-have-no-audio-description-1-2-5-6071f09f.webp)
...
Speak what the screen shows. The simplest way is a new soundtrack in which a voice reads each card and figure in the pauses that are already there, so no re-edit of the picture is needed. Otherwise publish a described version and offer it from the player ([G78](https://www.w3.org/WAI/WCAG22/Techniques/general/G78), [G173](https://www.w3.org/WAI/WCAG22/Techniques/general/G173)).
