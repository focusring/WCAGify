...
On the travel insurance page, the items under **"<span lang="nl">Niet verzekerd voor onder andere:</span>"** ("<span lang="nl">Schade door opzet</span>", "<span lang="nl">Schade onder invloed van alcohol, drugs of geneesmiddelen</span>", "<span lang="nl">Schade door een gevaarlijke sport</span>", "<span lang="nl">Schade tijdens zakelijke reizen</span>", "<span lang="nl">Medische kosten die niet noodzakelijk zijn</span>") are drawn in `#7d7d7d` on white. That is **4.11:1** at 16 px normal weight, against the required 4.5:1. The item "<span lang="nl">Contant geld</span>" in the "<span lang="nl">Standaard dekking</span>" card uses the same style.
