...
On step 2 of the application, the dropdown **"<span lang="nl">Wat is je nationaliteit?</span>"** is sized with `min-width: fit-content`, so it is always as wide as its longest option (545 px, "<span lang="nl">Inwoner van de Zuid-Georgia en de Zuidelijke Sandwicheilanden</span>"). When the page is zoomed the form column becomes narrower than that, and the dropdown runs past it into the form container, which cuts it off: 38 px at 125 % zoom (1024 px), 152 px at 150 %, 188 px at 800 px and 41 px at 200 %. The same happens at phone widths from 384 px up, such as 390 px.
