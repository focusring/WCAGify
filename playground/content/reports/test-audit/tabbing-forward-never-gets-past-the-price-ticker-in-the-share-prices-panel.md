...
Everything after the ticker is therefore out of forward reach: the Koersoverzicht links, the chart periods, the Top 5 tables, the whole "Financieel nieuws" block, and all 56 stops of the host page after the frame, footer and "Cookie-instellingen" included. Only Shift+Tab from the end of the page gets there, which a keyboard user has to guess.
