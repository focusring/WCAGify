...
The amount field **"<span lang="nl">Hoeveel wil je lenen?</span>"** in the loan calculator accepts only whole hundreds of euros, but that rule is stated nowhere until it has been broken. Typing 5050 gives "<span lang="nl">Ongeldige invoer. Voer het bedrag alleen in veelvouden van €100 in.</span>" Before that, the rule is not in the label, not near the field, and not in the info popover, which only gives the range "<span lang="nl">vanaf € 5.000 tot en met € 75.000</span>".
