...
This is a keyboard trap, and it also means that the zoomed layout loses a function the 1280 px layout has: closing the search and going back to the page. That is why it also fails 1.4.4 (at 200 %) and 1.4.10 (at 320 px). Reproduced on page-1, page-4 (at 800 × 900, a 1280 px window at 160 %), page-13, page-14, page-16, page-18, page-19, page-23, page-24 and page-26: it is the shared header, so it is on every page.
