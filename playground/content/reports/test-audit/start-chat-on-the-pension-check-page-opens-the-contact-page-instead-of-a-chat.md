...
Give this card the same chat link as the other pages. If the chat is meant to be unavailable here, name the link after where it goes, for example "<span lang="nl">Naar Service en Contact</span>" ([G91](https://www.w3.org/WAI/WCAG22/Techniques/general/G91)).
