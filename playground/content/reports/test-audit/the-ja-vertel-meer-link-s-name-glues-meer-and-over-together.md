...
In the "<span lang="nl">Gratis Overstapservice</span>" block on the payment-account page, the button-styled link reads **"<span lang="nl">Ja, vertel meer!</span>"** on screen, but its `aria-label` is "<span lang="nl">Ja, vertel meerover de Overstapservice!</span>". A missing space joins "meer" and "over" into one word.

The visible label is therefore not part of the accessible name: the name holds the word "meerover", not "meer". A speech-recognition user who says "<span lang="nl">klik Ja, vertel meer</span>" may not reach the link, because the software matches whole words. The name's intent is right; only the space is missing.
