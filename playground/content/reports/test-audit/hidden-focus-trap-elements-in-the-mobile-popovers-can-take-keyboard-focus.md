...
The same pair of guards sits in the "<span lang="nl">Kies Segment</span>" popover, the mobile navigation drawer and the search overlay, where axe asks for them to be reviewed (page-4, page-7, page-12, page-16, page-18, page-20, page-23 to page-26; on page-25 also in the "Openingstijden" popover). It is the same component everywhere.
